...
=pod
    ...
    # test_bitDB_get_put
    $bitdb = Bit::Set::DB2->new( SIZE_OF_TEST_BIT, 10 );
...
subtest 'BitDB Examples 1+2 (OO)' => sub {
    ...
    my $db1 = Bit::Set::DB2->new( $size, $num_of_bits );
    my $db2 = Bit::Set::DB2->new( $size, $num_of_ref_bits );
    ...
    my $num_threads = 4;
    my $opts        = Bit::Set::DB2::SETOP_COUNT_OPTS->new(
