...
my %functions = (
    ...
    Bit_new => {
        ...
        check => sub {
            my ($length) = @_;
            die "Bit_new: length must be >= 0 and <= INT_MAX" if $length < 0 || $length > 2147483647;
        }
    },
    Bit_free => {
        args => ['Bit_T*'],
    ...
    Bit_load => {
        ...
        check => sub {
            my ($length, $buffer) = @_;
            die "Bit_load: length must be >= 0 and <= INT_MAX" if $length < 0 || $length > 2147483647;
    ...
    Bit_buffer_size => {
        ...
        check => sub {
            my ($length) = @_;
            die "Bit_buffer_size: length must be >= 0 and <= INT_MAX" if $length < 0 || $length > 2147483647;
        }
    },
    Bit_length => {
        args => ['Bit_T'],
    ...
    Bit_diff => {
        ...
        check => sub {
            my ($s, $t) = @_;
            die "Bit_diff: bitsets cannot be NULL" if !defined $s || !defined $t;
        }
    },
    Bit_inter => {
        args => ['Bit_T', 'Bit_T'],
        ...
        check => sub {
            my ($s, $t) = @_;
            die "Bit_inter: bitsets cannot be NULL" if !defined $s || !defined $t;
        }
    },
    Bit_minus => {
        args => ['Bit_T', 'Bit_T'],
        ...
        check => sub {
            my ($s, $t) = @_;
            die "Bit_minus: bitsets cannot be NULL" if !defined $s || !defined $t;
        }
    },
    Bit_union => {
        args => ['Bit_T', 'Bit_T'],
        ...
        check => sub {
            my ($s, $t) = @_;
            die "Bit_union: bitsets cannot be NULL" if !defined $s || !defined $t;
        }
    },
    ...
    Bit_diff_count => {
        ...
        check => sub {
            my ($s, $t) = @_;
            die "Bit_diff_count: bitsets cannot be NULL" if !defined $s || !defined $t;
        }
    },
    Bit_inter_count => {
        args => ['Bit_T', 'Bit_T'],
        ...
        check => sub {
            my ($s, $t) = @_;
            die "Bit_inter_count: bitsets cannot be NULL" if !defined $s || !defined $t;
        }
    },
    Bit_minus_count => {
        args => ['Bit_T', 'Bit_T'],
        ...
        check => sub {
            my ($s, $t) = @_;
            die "Bit_minus_count: bitsets cannot be NULL" if !defined $s || !defined $t;
        }
    },
    Bit_union_count => {
        args => ['Bit_T', 'Bit_T'],
        ...
        check => sub {
            my ($s, $t) = @_;
            die "Bit_union_count: bitsets cannot be NULL" if !defined $s || !defined $t;
        }
    },
);
